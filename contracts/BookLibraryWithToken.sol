...
contract BookLibraryWithToken is Ownable {
    ...
    // Library Token with permits support
    Lib public libraryToken; 
    ...
    function borrowBookWithPermit(bytes32 bookId, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public {    
        ...
        Lib(libraryToken).transferFrom(msg.sender, address(this), borrowPrice);
        ...
        emit BookBorrowed(book.title, msg.sender, book.copies);
    }
